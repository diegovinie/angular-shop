...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function srcAppJsx(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _components_Filters__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./components/Filters */
    "./src/components/Filters/index.js");
    /* harmony import */


    var _components_Showcase__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./components/Showcase */
    "./src/components/Showcase/index.js");
    /* harmony import */


    var _components_SearchBar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./components/SearchBar */
    "./src/components/SearchBar/index.js");
    /* harmony import */


    var _components_Cart__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./components/Cart */
    "./src/components/Cart/index.js");
    /* harmony import */


    var _components_UrlForm__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./components/UrlForm */
    "./src/components/UrlForm/index.js");
    /* harmony import */


    var _components_SortFilters__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./components/SortFilters */
    "./src/components/SortFilters/index.js");
    /* harmony import */


    var _App_scss__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./App.scss */
    "./src/App.scss");

    var App = /*#__PURE__*/function (_react__WEBPACK_IMPOR) {
      _inherits(App, _react__WEBPACK_IMPOR);
      ...
      function App(props) {
        ...
        _this.dataService = props.dataService;
        _this.cartService = props.cartService;
        ...
        _this.updateProducts = _this.updateProducts.bind(_assertThisInitialized(_this));
        _this.sortProducts = _this.sortProducts.bind(_assertThisInitialized(_this));
        return _this;
      }
      ...
      _createClass(App, [{
        ...
        value: function componentDidMount() {
          ...
          this.dataService.getData().then(function (data) {
            _this2.mainFilter = {
              ...
              customFilter: _this2.state.customFilters[0],
              priceFilter: _this2.state.priceFilters[0]
            };
        ...
        value: function componentDidUpdate(_, prevState) {
          ...
          var sameFirst = prevState.products[0] === products[0];
          var sameLength = prevState.products.length === products.length; // trying to compare arrays
        ...
        value: function onURLChange(url) {
          ...
          this.dataService.getRemoteData(url).subscribe(function (data) {
            _this3.mainFilter = {
              search: '',
              categories: data.categories.slice(0),
              customFilter: _this3.state.customFilters[0],
              priceFilter: _this3.state.priceFilters[0]
            };

            _this3.cartService.flushCart();
        ...
        value: function onFilterChange(data) {
          if (data.type === 'category') {
            if (data.isChecked) {
              ...
              this.mainFilter.categories = this.mainFilter.categories.filter(function (category) {
        ...
        key: "updateProducts",
        value: function updateProducts(filter) {
          var _this4 = this;

          var _this$state = this.state,
              originalData = _this$state.originalData,
              products = _this$state.products;
          var productsSource = originalData.products;

          var prevProducts = _toConsumableArray(products);
          ...
          var nextProducts = productsSource.filter(function (product) {
            // Filter by search
            if (filterAllData || filter.type === 'search') {
              if (!product.name.match(new RegExp(_this4.mainFilter.search, 'i'))) {
                return false;
              }
            ...
            if (filterAllData || filter.type === 'category') {
              ...
              product.categories.forEach(function (product_category) {
                if (!passCategoryFilter) {
                  passCategoryFilter = _this4.mainFilter.categories.reduce(function (found, category) {
            ...
            if (filterAllData || filter.type === 'custom') {
              ...
              var customFilter = _this4.mainFilter.customFilter.value;
            ...
            if (filterAllData || filter.type === 'price') {
              ...
              var _customFilter = _this4.mainFilter.priceFilter.value;
              var productPrice = parseFloat(product.price.replace(/\./g, '').replace(',', '.'));

              if (_customFilter === 'all') {
                passPriceFilter = true;
              } else if (_customFilter === 'more_30000' && productPrice > 30000) {
                passPriceFilter = true;
              } else if (_customFilter === 'less_10000' && productPrice < 10000) {
                passPriceFilter = true;
              }
        ...
        key: "sortProducts",
        value: function sortProducts(criteria) {
          // console.log('sorting ' + this.products.length + ' products')
          var products = this.state.products.slice().sort(function (a, b) {
        ...
        value: function render() {
          var _this$state2 = this.state,
              originalData = _this$state2.originalData,
              customFilters = _this$state2.customFilters,
              priceFilters = _this$state2.priceFilters,
              sortFilters = _this$state2.sortFilters,
  ...
  /***/
  function srcAppScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAdaptersJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "mountComponent", function () {
    ...
    var mountComponent = function mountComponent(id) {
      return function (Component, props) {
        var el = document.getElementById(id);
        el && react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Component, props), el);
      };
    };
    /***/
  ...
  /***/
  function srcComponentsCartCartJsx(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _Cart_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./Cart.scss */
    ...
    var Cart = function Cart(props) {
      ...
      var _Object = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])({
        products: [],
        cartTotal: 0
      }),
          _Object2 = _slicedToArray(_Object, 2),
          _Object2$ = _Object2[0],
          products = _Object2$.products,
          cartTotal = _Object2$.cartTotal,
          setState = _Object2[1];

      var _Object3 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(false),
          _Object4 = _slicedToArray(_Object3, 2),
          expanded = _Object4[0],
          setExpanded = _Object4[1];

      var _Object5 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])('0'),
          _Object6 = _slicedToArray(_Object5, 2),
          expandedHeight = _Object6[0],
          setExpandedHeight = _Object6[1];

      var _Object7 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(false),
          _Object8 = _slicedToArray(_Object7, 2),
          animatePlop = _Object8[0],
          setAnimatePlop = _Object8[1];

      var _Object9 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(false),
          _Object10 = _slicedToArray(_Object9, 2),
          animatePopout = _Object10[0],
          setAnimatePopout = _Object10[1];

      var numProducts = Object(react__WEBPACK_IMPORTED_MODULE_0__["useMemo"])(function () {
      ...
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", null, "Esta es tu lista de compras:"), products.map(function (item) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
  ...
  /***/
  function srcComponentsCartCartScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcComponentsCartIndexJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _Cart_jsx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! ./Cart.jsx */
    "./src/components/Cart/Cart.jsx");
    /* harmony import */


    var _state_jsx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../../state.jsx */
    "./src/state.jsx");

    var mapStateToProps = function mapStateToProps(state) {
      var service = state.cartService;
      return {
    ...
    __webpack_exports__["default"] = Object(_state_jsx__WEBPACK_IMPORTED_MODULE_1__["connect"])(mapStateToProps)(_Cart_jsx__WEBPACK_IMPORTED_MODULE_0__["default"]);
    /***/
  },
  ...
  /***/
  function srcComponentsFiltersFiltersJsx(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _Filters_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./Filters.scss */
    ...
    var Filters = function Filters(props) {
      var categories = props.categories,
          ...
          priceFilters = props.priceFilters,
          filterChange = props.filterChange,
          label = props.label;
      var showFilters = true;

      var _Object11 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(false),
          _Object12 = _slicedToArray(_Object11, 2),
          sideShown = _Object12[0],
          setSideShown = _Object12[1];

      var onInputChange = function onInputChange(filter, type) {
        return function (e) {
          filterChange({
            type: type,
            filter: filter,
      ...
      }, "x"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h5", null, "Filtrar por categor\xEDa"), showFilters && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("form", null, categories && categories.map(function (filter) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          key: filter.name,
      ...
      })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h5", null, "Filtrar por precio"), showFilters && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("form", null, priceFilters.map(function (filter) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          key: filter.name,
      ...
      })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h5", null, "Filtros personalizados"), showFilters && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("form", null, customFilters.map(function (filter) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          key: filter.name,
          className: "custom-filter filter-wrapper"
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("label", {
  ...
  /***/
  function srcComponentsFiltersFiltersScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcComponentsFiltersIndexJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _Filters_jsx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! ./Filters.jsx */
    "./src/components/Filters/Filters.jsx");
    /* harmony default export */


    __webpack_exports__["default"] = _Filters_jsx__WEBPACK_IMPORTED_MODULE_0__["default"];
    /***/
  },
  ...
  /***/
  function srcComponentsProductThumbnailProductThumbnailJsx(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _ProductThumbnail_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./ProductThumbnail.scss */
    "./src/components/ProductThumbnail/ProductThumbnail.scss"); // import { CartService } from '../../app/cart.service';
    ...
    var ProductThumbnail = function ProductThumbnail(props) {
      ...
      var _Object13 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(false),
          _Object14 = _slicedToArray(_Object13, 2),
          detailViewActive = _Object14[0],
          setDetailViewActive = _Object14[1];
    ...
    __webpack_exports__["default"] = ProductThumbnail;
    /***/
  },
  ...
  /***/
  function srcComponentsProductThumbnailProductThumbnailScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcComponentsProductThumbnailIndexJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _ProductThumbnail_jsx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    ...
    __webpack_exports__["default"] = Object(_state_jsx__WEBPACK_IMPORTED_MODULE_1__["connect"])(mapStateToProps)(_ProductThumbnail_jsx__WEBPACK_IMPORTED_MODULE_0__["default"]);
    /***/
  },
  ...
  /***/
  function srcComponentsSearchBarSearchBarJsx(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _SearchBar_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./SearchBar.scss */
    ...
    var SearchBar = function SearchBar(props) {
      ...
      var _Object15 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(true),
          _Object16 = _slicedToArray(_Object15, 2),
          showSearch = _Object16[0],
          setShowSearch = _Object16[1];

      var _Object17 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(false),
          _Object18 = _slicedToArray(_Object17, 2),
          animatePlop = _Object18[0],
          setAnimatePlop = _Object18[1];

      var _Object19 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])({
        search: '',
        change: 0
      }),
          _Object20 = _slicedToArray(_Object19, 2),
          search = _Object20[0],
          setSearch = _Object20[1];
  ...
  /***/
  function srcComponentsSearchBarSearchBarScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcComponentsSearchBarIndexJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _SearchBar_jsx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! ./SearchBar.jsx */
    "./src/components/SearchBar/SearchBar.jsx");
    /* harmony default export */


    __webpack_exports__["default"] = _SearchBar_jsx__WEBPACK_IMPORTED_MODULE_0__["default"];
    /***/
  },
  ...
  /***/
  function srcComponentsShowcaseShowcaseJsx(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _ProductThumbnail__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../ProductThumbnail */
    "./src/components/ProductThumbnail/index.js");
    ...
    var Showcase = function Showcase(props) {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ProductThumbnail__WEBPACK_IMPORTED_MODULE_1__["default"], {
          key: product.name,
          product: product,
          className: "col-4"
        });
  ...
  /***/
  function srcComponentsShowcaseIndexJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _Showcase_jsx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! ./Showcase.jsx */
    "./src/components/Showcase/Showcase.jsx");
    /* harmony default export */


    __webpack_exports__["default"] = _Showcase_jsx__WEBPACK_IMPORTED_MODULE_0__["default"];
    /***/
  },
  ...
  /***/
  function srcComponentsSortFiltersSortFiltersJsx(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _SortFilters_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./SortFilters.scss */
    "./src/components/SortFilters/SortFilters.scss");

    var SortFilters = function SortFilters(props) {
    ...
    __webpack_exports__["default"] = SortFilters;
    /***/
  },
  ...
  /***/
  function srcComponentsSortFiltersSortFiltersScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcComponentsSortFiltersIndexJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _SortFilters_jsx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! ./SortFilters.jsx */
    "./src/components/SortFilters/SortFilters.jsx");
    /* harmony default export */


    __webpack_exports__["default"] = _SortFilters_jsx__WEBPACK_IMPORTED_MODULE_0__["default"];
    /***/
  },
  ...
  /***/
  function srcComponentsUrlFormUrlFormJsx(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _UrlForm_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./UrlForm.scss */
    "./src/components/UrlForm/UrlForm.scss");

    var UrlForm = function UrlForm(props) {
      var urlChange = props.urlChange;

      var _Object21 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(false),
          _Object22 = _slicedToArray(_Object21, 2),
          expanded = _Object22[0],
          setExpanded = _Object22[1];

      var _Object23 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(''),
    ...
    __webpack_exports__["default"] = UrlForm;
    /***/
  },
  ...
  /***/
  function srcComponentsUrlFormUrlFormScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcComponentsUrlFormIndexJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _UrlForm_jsx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! ./UrlForm.jsx */
    "./src/components/UrlForm/UrlForm.jsx");
    /* harmony default export */


    __webpack_exports__["default"] = _UrlForm_jsx__WEBPACK_IMPORTED_MODULE_0__["default"];
    /***/
  },
  ...
  function srcMainTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _adapters__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! ./adapters */
    "./src/adapters.js");
    /* harmony import */
    ...
    var _App_jsx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./App.jsx */
    "./src/App.jsx");
    /* harmony import */


    var _services_CartService__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./services/CartService */
    "./src/services/CartService.ts");
    /* harmony import */


    var _services_DataService__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./services/DataService */
    "./src/services/DataService.ts"); // services
    // instanciate services


    var dataService = new _services_DataService__WEBPACK_IMPORTED_MODULE_4__["DataService"]();
    var cartService = new _services_CartService__WEBPACK_IMPORTED_MODULE_3__["CartService"](); // initialize react psudo-store

    Object(_state_jsx__WEBPACK_IMPORTED_MODULE_1__["initState"])({
    ...
    var CartService = /*#__PURE__*/function () {
      ...
      _createClass(CartService, [{
        ...
        value: function addProductToCart(product) {
          ...
          this.cartTotal += parsedPrice; // Search this product on the cart and increment the quantity
        ...
        value: function deleteProductFromCart(product) {
          var _this5 = this;

          this.products = this.products.filter(function (_product) {
            if (_product.product.id === product.id) {
              _this5.cartTotal -= _product.product.parsedPrice * _product.quantity;
              return false;
            }
  ...
  function srcServicesDataServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var rxjs_fetch__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! rxjs/fetch */
    ...
    var DataService = /*#__PURE__*/function () {
      ...
      _createClass(DataService, [{
        ...
        key: "getRemoteData",
        value: function getRemoteData(url) {
  ...
  /***/
  function srcServicesMockDataTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcStateJsx(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "getActionFromService", function () {
      return getActionFromService;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "initState", function () {
      return initState;
    });
    /* harmony export (binding) */
    ...
    var getActionFromService = function getActionFromService(service, actionName) {
      return service && service[actionName] && service[actionName].bind(service);
    };
    ...
    var connect = function connect(mapper) {
      return function (Component) {
        return function (props) {
          var mappedState = mapper(state);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/aire/coding/playground/angular-shop/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
